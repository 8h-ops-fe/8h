  ...
  Marquee = (function() {
    ...
    Marquee.prototype.prev = function() {
      ...
      if (this.cache.allowMarquee) {
        ...
        ul = this.elements.ul;
        var rightImgInfo = ul.children().slice(1, 2).find("img").attr("alt");/*my var:next img*/
        this.settings.prevBefore.call(this,rightImgInfo);
        ...
        _this.settings.prevAfter.call(_this,rightImgInfo);
        });
      }
    };
    ...
    Marquee.prototype.next = function() {
      ...
      if (this.cache.allowMarquee) {
        this.cache.moveBefore.call(this);
        ul = this.elements.ul;
        var leftImgInfo = ul.children().slice(-1).find("img").attr("alt");/*my var:left img*/
        this.settings.nextBefore.call(this,leftImgInfo);
        ...
        ul.css(_this.cache.leftOrTop, -this.cache.stepW).animate(this.cache.nextAnimateObj, this.settings.speed, function() {
          sufEls.remove();
          _this.cache.moveAfter.call(_this);
          _this.settings.nextAfter.call(_this,leftImgInfo);
        });
      }
    };

...
define(function (require, exports, module) {
    ...
    if (!window.SyntaxHighlighter) {
        var SyntaxHighlighter = function () {
            var a = {
                    ...
                    create: function (d) {
                        ...
                        expandSource: function (b) {
                            ...
                            this.execute = function (d, g, c) {
                                var f = a.utils.fixInputString(b.originalCode).replace(/</g, "&lt;"), e = a.utils.popup("", "_blank", 750, 400, "location=0, resizable=1, menubar=0, scrollbars=1");
                            ...
                            this.create = function () {
                                ...
                                if (/msie/i.test(navigator.userAgent)) {
                                    ...
                                    }) + f(k) + ">" + l(j) + l({movie: i}) + "</object>"
                                } else {
                                    h = "<embed" + f(k) + f(j) + f({src: i}) + "/>"
                                }
                            ...
                            this.execute = function (c, e) {
                                var d = a.utils.popup("", "_blank", 500, 250, "scrollbars=0"), f = d.document;
                ...
                utils: {
                    indexOf: function (e, b, d) {
                        ...
                        var d, c = {}, e = new XRegExp("^\\[(?<values>(.*?))\\]$"), f = new XRegExp("(?<name>[\\w-]+)" + "\\s*:\\s*" + "(?<value>" + "[\\w-%#]+|" + "\\[.*?\\]|" + '".*?"|' + "'.*?'" + ")\\s*;?", "g");
                        ...
                        var c = document.createElement("div"), h, j = 0, f = document.body, d = a.utils.guid("measureSpace"), i = '<div class="', g = "</div>", e = "</span>";
                ...
                highlight: function (h, f) {
                    ...
                    var b = f ? [f] : e(document.getElementsByTagName(a.config.tagName)), j = "innerHTML", n = null, l = a.config;
                    if (l.useScriptTags) {
            ...
            a.HtmlScript = function (b) {
                ...
                h.regexList.push({regex: c.htmlScript.code, func: f});
                function e(k, l) {
                ...
                function f(r, l) {
                    var k = r.code, q = [], p = c.regexList, n = r.index + r.left.length, s = c.htmlScript, t;
            ...
            a.Highlighter.prototype = {
                getParam: function (d, c) {
                    ...
                    var n = b.split("\n"), l = parseInt(this.getParam("first-line")), h = this.getParam("pad-line-numbers"), m = this.getParam("highlight", []), f = this.getParam("gutter");
                    b = "";
                    if (h == true) {
                    ...
                    for (var g = 0; g < n.length; g++) {
                        var o = n[g], c = /^(&nbsp;|\s)+/.exec(o), k = "alt" + (g % 2 == 0 ? 1 : 2), d = a.utils.padNumber(l + g, h), e = a.utils.indexOf(m, (l + g).toString()) != -1, j = null;
                        if (c != null) {
                            j = c[0].toString();
                            o = o.substr(j.length)
                        }
                    ...
                    var j = 0, l = "", c = a.utils.decorate, k = this.getParam("brush-name", "");
                    ...
                    this.htmlScript = {
                        left: {regex: b.left, css: "script"},
                        right: {regex: b.right, css: "script"},
    ...
    if (!window.XRegExp) {
        (function () {
            ...
            XRegExp = function (o, i) {
                                ...
                                if (l[5]) {
                                    ...
                                    if (l[6]) {
                                        if (o.charAt(g.lastIndex) === "]") {
                                            ...
                                            j = XRegExp.matchRecursive("&&" + o.slice(l.index), d.classLeft, d.classRight, "", {escapeChar: "\\"})[0];
                                            h.push(l[6] + j + "]");
                ...
                q._x = {source: o, captureNames: p ? r : null};
                return q
            };
    ...
    RegExp.prototype.addFlags = function (a) {
        ...
        if (this._x) {
            b._x = {source: this._x.source, captureNames: this._x.captureNames ? this._x.captureNames.slice(0) : null}
        }
        return b
    };
    ...
    XRegExp.matchRecursive = function (p, d, s, f, b) {
        var b = b || {}, v = b.escapeChar, k = b.valueNames, f = f || "", q = f.indexOf("g") > -1, c = f.indexOf("i") > -1, h = f.indexOf("m") > -1, u = f.indexOf("y") > -1, f = f.replace(/y/g, ""), d = d instanceof RegExp ? (d.global ? d : d.addFlags("g")) : new XRegExp(d, "g" + f), s = s instanceof RegExp ? (s.global ? s : s.addFlags("g")) : new XRegExp(s, "g" + f), i = [], a = 0, j = 0, n = 0, l = 0, m, e, o, r, g, t;
        if (v) {
            if (v.length > 1) {
    ...
    SyntaxHighlighter.brushes.ColdFusion = function () {
        ...
        this.regexList = [{
            ...
            css: "functions"
        }, {regex: new RegExp(this.getKeywords(a), "gmi"), css: "color1"}, {
    ...
    SyntaxHighlighter.brushes.Cpp = function () {
        ...
        this.regexList = [{
            ...
            regex: new RegExp(this.getKeywords(b), "gm"),
            css: "functions bold"
        }, {regex: new RegExp(this.getKeywords(a), "gm"), css: "keyword bold"}]
    };
    ...
    SyntaxHighlighter.brushes.CSS = function () {
        ...
        this.regexList = [{
            ...
            regex: /!important/g,
            css: "color3"
        }, {regex: new RegExp(a(d), "gm"), css: "keyword"}, {
            regex: new RegExp(c(b), "g"),
            css: "value"
        }, {regex: new RegExp(this.getKeywords(e), "g"), css: "color1"}];
    ...
    SyntaxHighlighter.brushes.Delphi = function () {
        ...
        this.regexList = [{regex: /\(\*[\s\S]*?\*\)/gm, css: "comments"}, {
            ...
            regex: /\$[a-zA-Z0-9]+\b/g,
            css: "value"
        }, {regex: new RegExp(this.getKeywords(a), "gmi"), css: "keyword"}]
    };
    ...
    SyntaxHighlighter.brushes.Groovy = function () {
        ...
        this.regexList = [{
            ...
            css: "value"
        }, {regex: new RegExp(this.getKeywords(d), "gm"), css: "keyword"}, {
            regex: new RegExp(this.getKeywords(c), "gm"),
            css: "color1"
        }, {regex: new RegExp(this.getKeywords(b), "gm"), css: "constants"}, {
            regex: new RegExp(this.getKeywords(a), "gm"),
            css: "functions"
        }];
        this.forHtmlScript(SyntaxHighlighter.regexLib.aspScriptTags)
    ...
    SyntaxHighlighter.brushes.Java = function () {
        ...
        this.regexList = [{
            ...
            css: "color1"
        }, {regex: /\@interface\b/g, css: "color2"}, {regex: new RegExp(this.getKeywords(a), "gm"), css: "keyword"}];
    ...
    SyntaxHighlighter.brushes.JavaFX = function () {
        ...
        this.regexList = [{
            ...
            css: "color2"
        }, {regex: new RegExp(this.getKeywords(b), "gm"), css: "variable"}, {
            regex: new RegExp(this.getKeywords(a), "gm"),
            css: "keyword"
        }];
        this.forHtmlScript(SyntaxHighlighter.regexLib.aspScriptTags)
    ...
    SyntaxHighlighter.brushes.Perl = function () {
        ...
        this.regexList = [{regex: new RegExp("#[^!].*$", "gm"), css: "comments"}, {
            ...
            css: "variable"
        }, {regex: new RegExp(this.getKeywords(a), "gmi"), css: "functions"}, {
            regex: new RegExp(this.getKeywords(b), "gm"),
            css: "keyword"
        }];
    ...
    SyntaxHighlighter.brushes.Php = function () {
        ...
        this.regexList = [{
            ...
            css: "functions"
        }, {regex: new RegExp(this.getKeywords(b), "gmi"), css: "constants"}, {
            regex: new RegExp(this.getKeywords(c), "gm"),
            css: "keyword"
        }];
        this.forHtmlScript(SyntaxHighlighter.regexLib.phpScriptTags)
    ...
    SyntaxHighlighter.brushes.Python = function () {
        ...
        this.regexList = [{regex: SyntaxHighlighter.regexLib.singleLinePerlComments, css: "comments"}, {
            ...
            regex: new RegExp(this.getKeywords(a), "gmi"),
            css: "functions"
        }, {regex: new RegExp(this.getKeywords(c), "gm"), css: "keyword"}, {
            regex: new RegExp(this.getKeywords(b), "gm"),
            css: "color1"
        }];
        this.forHtmlScript(SyntaxHighlighter.regexLib.aspScriptTags)
    ...
    SyntaxHighlighter.brushes.Scala = function () {
        ...
        this.regexList = [{
            ...
            css: "value"
        }, {regex: new RegExp(this.getKeywords(b), "gm"), css: "keyword"}, {regex: new RegExp(a, "gm"), css: "keyword"}]
    };
    ...
    SyntaxHighlighter.brushes.Sql = function () {
        ...
        this.regexList = [{
            ...
            regex: SyntaxHighlighter.regexLib.multiLineSingleQuotedString,
            css: "string"
        }, {regex: new RegExp(this.getKeywords(b), "gmi"), css: "color2"}, {
            regex: new RegExp(this.getKeywords(a), "gmi"),
            css: "color1"
        }, {regex: new RegExp(this.getKeywords(c), "gmi"), css: "keyword"}]
    };
    ...
    SyntaxHighlighter.brushes.Vb = function () {
        ...
        this.regexList = [{regex: /'.*$/gm, css: "comments"}, {
            regex: SyntaxHighlighter.regexLib.doubleQuotedString,
            css: "string"
        }, {regex: /^\s*#.*$/gm, css: "preprocessor"}, {regex: new RegExp(this.getKeywords(a), "gm"), css: "keyword"}];
        this.forHtmlScript(SyntaxHighlighter.regexLib.aspScriptTags)
    };
